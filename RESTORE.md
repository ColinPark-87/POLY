...
| 변경 커밋 | `6f6fd3a` (호차별 정류장 탭: 방향토글+최早시간, 시스템탭 일치 / 이전 68dd041·d8ea76f) |
| Vercel 롤백 대상 (직전 라이브) | `poly-gxfkflq58-colinpark-87s-projects.vercel.app` (탭 신설 전) |
| 현재 라이브 | `poly-88il8g178-colinpark-87s-projects.vercel.app` / https://poly-system.vercel.app (2026-06-30) |
