...
| 변경 커밋 | `fc452f3` (호차별 정류장 평면 인라인 편집표:이름·시간·좌표·주소검색·저장+요일점끄기 / 이전 3aaf5b4·876448e) |
| Vercel 롤백 대상 (직전 라이브) | `poly-gxfkflq58-colinpark-87s-projects.vercel.app` (탭 신설 전) |
| 현재 라이브 | `poly-r1mbv6wkh-colinpark-87s-projects.vercel.app` / https://poly-system.vercel.app (2026-06-30) |
