...
| 변경 커밋 | `bb862b3` (호차별 정류장 세션탭 4개:유치부/매일반/3일반/화목반 / 이전 7be1e32·d578ae7·6f6fd3a) |
| Vercel 롤백 대상 (직전 라이브) | `poly-gxfkflq58-colinpark-87s-projects.vercel.app` (탭 신설 전) |
| 현재 라이브 | `poly-k6udetcez-colinpark-87s-projects.vercel.app` / https://poly-system.vercel.app (2026-06-30) |
