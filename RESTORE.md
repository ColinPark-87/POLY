...
| 변경 커밋 | `7be1e32` (호차별 정류장 탭: 시간칸 넓힘·전체폭 / 이전 d578ae7·6f6fd3a·68dd041) |
| Vercel 롤백 대상 (직전 라이브) | `poly-gxfkflq58-colinpark-87s-projects.vercel.app` (탭 신설 전) |
| 현재 라이브 | `poly-ji75addck-colinpark-87s-projects.vercel.app` / https://poly-system.vercel.app (2026-06-30) |
