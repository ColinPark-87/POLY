...
| 백업 브랜치 | `backup/pre-presence-editfix-20260617` (직전: `backup/pre-presence-alltabs-20260617`) (직전: `backup/pre-presence-edit-deploy-20260617`) |
...
| 롤백 방법 | `vercel promote poly-q239atar2-colinpark-87s-projects.vercel.app` (즉시 라이브 롤백) 또는 `git checkout backup/pre-presence-editfix-20260617` (직전: `backup/pre-presence-alltabs-20260617`) 후 재배포 |
