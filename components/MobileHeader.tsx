  ...
  return (
    <header className="flex md:hidden items-center justify-between px-4 py-3 bg-white border-b border-[#E2E8F0] sticky top-0 z-40">
      <div className="flex items-center gap-2">
        <div className="w-7 h-7 rounded-lg bg-[#004EA2] flex items-center justify-center">
      ...
      <button
        ...
        className="text-xs text-[#64748B] px-3 py-1.5 rounded-lg border border-[#E2E8F0] hover:bg-[#F7F8FA]"
      >
        로그아웃
      </button>
    </header>
